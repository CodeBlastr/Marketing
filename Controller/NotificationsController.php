...
//			break;
            ...
            $recipientData = $this->Notification->print_r_reverse($notification['Notification']['recipients_array']);
            // trim up the array's values
            $this->Notification->mungeFormData($recipientData);

            //$recipientData = unserialize($notification['Notification']['recipients_array']);
            //debug($notification['Notification']['recipients_array']);break;
            //echo($notification['Notification']['recipients_array']);
//           debug($recipientData);
//            break;
...
//debug($recipientLookupArray['thisDataLookup']['model']);
//debug($recipientLookupArray['thisDataLookup']['field']);
//debug($lookupId);
//debug($thisData);
